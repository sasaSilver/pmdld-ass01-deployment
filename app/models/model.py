...
class AttractivenessClassifier:
    ...
    def train(
        ...
        for epoch in range(epochs):
            ...
            for phase in ['train', 'val']:
                ...
                for inputs, labels in dataloader:
                    ...
                    labels = labels.to(self._device).view(-1, 1)  # Ensure correct shape [batch_size, 1]
                ...
                if phase == 'val' and epoch_loss < best_loss:
                    ...
                    torch.save(self._model.state_dict(), config.model_path)
        ...
        self._model.load_state_dict(torch.load(config.model_path))
        self._model.eval()
        
        final_mae, final_rmse = self.evaluate(test_loader, self._device)
        print(f'Final Test MAE: {final_mae:.4f}')
        print(f'Final Test RMSE: {final_rmse:.4f}')
    
    def evaluate(self, test_loader: DataLoader, device: torch.device):
        self._model.eval()
